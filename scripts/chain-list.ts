...
export default [
  ...
  { chain: c.blast, color: "#FCFC03", icon: "blast", alchemy: "blast-mainnet", disperse: true },
  { chain: c.linea, color: "#61DFFF", icon: "linea", alchemy: "linea-mainnet", disperse: true },
  { chain: c.scroll, color: "#FFEEDA", icon: "scroll", alchemy: "scroll-mainnet", disperse: true },
  { chain: c.zkSync, color: "#8C8DFC", icon: "zksync", alchemy: "zksync-mainnet", trust: "zksync" },
  { chain: c.manta, color: "#15B5E0", icon: "manta-pacific" },
  { chain: c.mantle, color: "#000000", icon: "mantle", alchemy: "mantle-mainnet", disperse: true },
  { chain: c.celo, color: "#FCFF52", icon: "celo", alchemy: "celo-mainnet", disperse: true },
  {
    chain: c.gnosis,
    color: "#04795B",
    icon: "gnosis",
  ...
  { chain: c.moonriver, color: "#F2B705", icon: "moonriver", disperse: true },
  ...
  { chain: c.fraxtal, color: "#000000", icon: "fraxtal", disperse: true },
  ...
  { chain: c.apeChain, color: "#0054FA", icon: "apechain", disperse: true },
  { chain: c.worldchain, color: "#000000", icon: "world", disperse: true },
  { chain: c.bob, color: "#F25E31", icon: "bob" },
  { chain: c.lisk, color: "#4070F4", icon: "lisk" },
  { chain: c.redstone, color: "#F34242" },
  { chain: c.sei, color: "#9B1B2E", icon: "sei-network", disperse: true },
  { chain: c.taiko, color: "#E81899", icon: "taiko", disperse: true },
  { chain: c.berachain, color: "#7C3503", disperse: true },
  { chain: c.abstract, color: "#1D1D1B", icon: "abstract", disperse: true },
  { chain: c.ink, color: "#7C5CFF", icon: "ink" },
  { chain: c.hemi, color: "#FF6B35", icon: "hemi" },
  // ── Testnets (same order as parent mainnet) ──
  { chain: c.sepolia, icon: "ethereum", alchemy: "eth-sepolia", disperse: true },
  ...
  // ── Local dev ──
  { chain: { ...c.hardhat, testnet: true }, disperse: true },
] satisfies {
