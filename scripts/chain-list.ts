...
export default [
  ...
  { chain: c.iotex, color: "#00D4AA", icon: "iotex" },
  ...
  { chain: c.astar, color: "#0070EB", icon: "astar", alchemy: "astar-mainnet" },
  ...
  { chain: c.berachain, color: "#7C3503", icon: "berachain" },
  ...
  { chain: c.berachainBepolia, icon: "berachain" },
