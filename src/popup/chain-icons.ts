...
import {
  ...
  metis, zora, mode, fraxtal, kava, harmonyOne,
  klaytn, filecoin, fuse, iotex, rootstock, telos, boba,
  flare, astar, arbitrumNova, apeChain, worldchain, bob, lisk,
  sei, taiko, berachain, abstract as abstractChain, ink, hemi,
  ...
  celoAlfajores, fantomTestnet, moonbaseAlpha,
  cronosTestnet, modeTestnet, fraxtalTestnet,
  kavaTestnet, klaytnBaobab, filecoinCalibration,
  telosTestnet, bobaSepolia, flareTestnet,
  bobSepolia, liskSepolia, worldchainSepolia,
  seiTestnet, taikoHekla, berachainBepolia,
  abstractTestnet, inkSepolia, hemiSepolia,
} from "viem/chains";
